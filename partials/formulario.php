        ...
        <div class="container">
          ...
          <form action="/action_page.php" method="get">
            ...
            <div class="row form-inputs" id="crc">
              <div class="col-sm-12 col-md-6">
                <label for="dpi">Fecha, Lugar expedición</label>
                <input type="text" id="dpi" name="dpi">
              </div>
              <div class="col-sm-12 col-md-6">
                <label for="sctr">Dirección Res./sct</label>
            ...
            <div class="row form-inputs" id="crd">
              ...
              <div class="col-sm-12 col-md-6">
                <label for="area">Área/Cargo</label>
            ...
            <div class="row form-inputs" id="cre">
              <div class="col-sm-12 col-md-6">
                <label for="cadd">Dirección Empresa</label>
            ...
            <div class="row form-inputs" id="crf">
              <div class="col-sm-12 col-md-6">
                <label for="job">Profesión/Oficio/Ocup.</label>
            ...
            <div class="row form-inputs" id="cri">
              <div class="col-sm-12 col-md-6">
                <label for="tnumb">No. Teléfono</label>
            ...
            <div class="ginfo row form-inputs" id="crj">
              ...
              <p class="ginfo-para">De acuerdo con lo establecido en el numeral 19 del artículo 2 de la Ley 155/17, las
                personas políticamente
                expuestas (PEP) son aquellos funcionarios obligados a presentar su declaración jurada de bienes conforme
                al artículo 2 de la Ley 311-14 de declaración jurada de patrimonio, y. cuando se identifiquen como
                personas
                de alto riesgo, sus conyugues, parejas y demás personas con las que un PEP mantenga parentesco por
            ...
            <div class="row form-inputs" id="crk">
              ...
              <div class="col-md-6">
                <p class="question">
                  ¿Ejerce algún grado de poder político?
                </p>
                <div class="row">
                  <div class="col-sm-6">
                    <input type="radio" class="yes" name="yes" value="yes">
            ...
            <div class="row form-inputs" id="crl">
              ...
              <div class="col-md-6">
                <p class="question">
                  ¿Existe algún vínculo familiar con un PEP?
                </p>
                <div class="row">
                  <div class="col-sm-6">
                    <input type="radio" class="yes" name="yes" value="yes">
            ...
            <div class="row form-inputs" id="crn">
              <p>Yo, <input type="text" name="fblank" id="fblank">; Documento de identidad número<input type="text"
                ...
                para esta operación:
                como mis actividades, mi profesión y oficio son lícitos, los ejerzo dentro de un marco legal y los
                recursos que poseo no
                provienen de actividades ilícitas, ni se destinarán a financiar terrorismo o violan los establecido por
                el código penal o
                Las Leyes de la República Dominicana. Conozco, declaro y acepto que MARINO MARRERO y sus Agentes están
                en la
                obligación legal de solicitar las aclaraciones que estimen pertinentes, ante el caso de que se presenten
                circunstancias en
                en base a las cuales la Unidad de Análisis Financiero (UAF), pueda tener dudas razonables sobre mis
                operaciones, así
                como del origen de mis activos, evento ante el cual suministraría las aclaraciones pertinentes. El
                origen de los fondos
                para esta operación es:<input type="text" name="thblank" id="thblank"></p>
            </div>

            <div class="row form-inputs" id="cro">
              <div class="col-md-12">
                <p><b>Autorizo a la UAF y al ente encargado de la Supervisión a los Sujetos Obligados No Financieros a
                    corroborar la
                    veracidad de la información aquí suministrada y a obtener y solicitar cualquier información
                    adicional</b></p>
              </div>
            </div>
            ...
            <div class="row form-inputs" id="crq">
              <div class="col-md-12">
                <p><small>Información adicional <b>info@mercantil.com.do</b></small></p>
              </div>
            </div>
